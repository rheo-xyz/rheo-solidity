...
contract BaseTestGenericMarket is BaseTest {
    ...
    function setUp_USDT_cbBTC() public {
        ...
        vm.label(address(size.data().borrowTokenVault), "szaBTK (szacbBTC) (v1.5)");
    ...
    function setUp_cbBTC_USDC() public {
        ...
        vm.label(address(size.data().borrowTokenVault), "szaBTK (szaUSDC) (v1.5)");
    ...
    function setUp_wstETH_ETH() public {
        ...
        vm.label(address(size.data().borrowTokenVault), "szaBTK (szaETH) (v1.5)");
