...
contract PriceFeedMorphoChainlinkOracleV2Test is Test, AssertsHelper {
    ...
    function setUp() public {
        ...
        priceFeed = new PriceFeedMorphoChainlinkOracleV2(IMorphoChainlinkOracleV2(address(morphoOracle)));
    }

    function test_PriceFeedMorphoChainlinkOracleV2_constructor_validation() public {
        // Test null oracle
        vm.expectRevert(abi.encodeWithSelector(Errors.NULL_ADDRESS.selector));
        new PriceFeedMorphoChainlinkOracleV2(IMorphoChainlinkOracleV2(address(0)));
    }
    ...
    function test_PriceFeedMorphoChainlinkOracleV2_different_scale_factor() public {
        ...
        PriceFeedMorphoChainlinkOracleV2 customPriceFeed =
            new PriceFeedMorphoChainlinkOracleV2(IMorphoChainlinkOracleV2(address(customOracle)));
